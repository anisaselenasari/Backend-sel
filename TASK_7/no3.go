// DRAGON OF LOOWATER
// Ada n kepala naga dan m ksatria (1 n, m 20000). Setiap kepala naga memiliki diameter dan setiap ksatria memiliki tinggi.
// Sebuah kepala naga dengan diameter D dapat dipenggal oleh seorang ksatria dengan tinggi H jika D H. Seorang ksatria hanya dapat memenggal satu kepala naga.
// Diberikan daftar diameter kepala naga dan daftar tinggi ksatria,
// apakah mungkin untuk memenggal semua kepala naga? Jika ya, berapa tinggi total minimum ksatria yang digunakan untuk memenggal kepala naga?
